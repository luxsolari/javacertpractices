...
public class Recap {
    ...
    /*
     * A String in java is an object that represents an array of characters 
     * but is NOT an array of the primitive data type char.
     * 
     * When created without a constructor (not using the new keyword), a string is placed in a special area
     * called "String pool" to maintain unique strings; this process is known as "interning" the string.
     */
